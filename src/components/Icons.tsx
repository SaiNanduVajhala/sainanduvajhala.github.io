...
export const LinkedinIcon: React.FC<{ size?: number }> = ({ size = 18 }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
    ...
    <rect x="2" y="9" width="4" height="12" fill="none" stroke="currentColor" />
    <circle cx="4" cy="4" r="2" fill="none" stroke="currentColor" />
  </svg>
);

export const MailIcon: React.FC<{ size?: number }> = ({ size = 18 }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
...
export const LayersIcon: React.FC<{ size?: number }> = ({ size = 16 }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
...
export const HistoryIcon: React.FC<{ size?: number }> = ({ size = 16 }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
...
export const ArrowRightIcon: React.FC<{ size?: number; className?: string }> = ({ size = 14, className }) => (
...
export const ExternalArrowIcon: React.FC = () => (
...
export const BulletIcon: React.FC = () => (
  <svg viewBox="0 0 24 24" width="7" height="7" stroke="currentColor" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--accent)', marginTop: '0.4rem' }}>
    <polyline points="9 18 15 12 9 6" />
  </svg>
);

export const CopyIcon: React.FC<{ size?: number }> = ({ size = 14 }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
